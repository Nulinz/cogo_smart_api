...
use App\Http\Controllers\Chart_cnt;
...
Route::middleware(['tenant.db', 'jwt.auth'])->group(function () {
    ...
    Route::post('/party_inactive', [Party_cnt::class, 'party_inactive']);
    Route::post('/party_status_update', [Party_cnt::class, 'party_status_update']);
    ...
    Route::post('/day_profit_loss', [Stock_cnt::class, 'day_profit_loss']);
    ...
    Route::post('/edit_petty_cash', [Stock_cnt::class, 'edit_petty_cash']);
    ...
    Route::post('/edit_expense', [Exp_cnt::class, 'edit_expense']);
    ...
    Route::post('/profit_loss_month', [Chart_cnt::class, 'profit_loss_month']);
    Route::post('/profit_loss_party', [Chart_cnt::class, 'profit_loss_party']);
    Route::post('/party_farmer_advance_chart', [Chart_cnt::class, 'party_farmer_advance']);
