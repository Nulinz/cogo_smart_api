...
<head>
    ...
    <link rel="shortcut icon" href="{{ asset('images/icons/lb-tab.png') }}" type="image/x-icon">
                ...
                <div class="col-12 col-sm-10 col-md-8 col-lg-5 col-xl-4">
                    ...
                    <div class="glass-card">
                        ...
                        <div class="text-center mb-4">
                            ...
                            <h3 class="fw-bold text-white mt-3">Create Password</h3>
                        </div>
                        ...
                        <form action="" method="POST">
                            ...
                            <div class="mb-4">
                                <label class="glass-label">New Password</label>
                                <div class="position-relative">
                                    <i class="fas fa-lock input-icon-left"></i>
                                    <input type="password" class="form-control glass-input" name="new_password" placeholder="**********" required>
                                </div>
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <div class="position-relative">
                                    <i class="fas fa-lock input-icon-left"></i>
                                    <input type="password" class="form-control glass-input" name="confirm_password" placeholder="**********" required>
                                </div>
                            </div>

                            <button type="submit" class="btn btn-green w-100 shadow-sm">Save password</button>
